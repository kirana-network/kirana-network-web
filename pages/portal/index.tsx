...
import { Stepper, Step, StepLabel, Typography, Dialog, AppBar, Toolbar, IconButton, Button, Box } from "@mui/material";
...
import { UserProfile, UserProfileOrganization } from "../../core/apiClient";
import Loading from "../../components/Common/Loading";
import { _UserprofilesApi, _OrganizationsApi, registerDependencies } from "../../core/getIt";
import { getLoggingInstance } from "../../core/utils/logger";
        ...
        return [
            {
                ...
                onClick: () => {
                    return Promise.resolve(router.push("/organizations/create"));
                }
            },
            {
                ...
                onClick: () => {
                    return Promise.resolve(router.push(`/organizations/${adminOrganizationId}/invitations`));
                }
            },
            {
                ...
                onClick: () => {
                    return Promise.resolve({});
                    // return Promise.resolve(router.push(`/clients/create`, {
            ...
            },
            {
                ...
                onClick: () => {
                    return Promise.resolve({});
                    // return Promise.resolve(router.push(`/trips/create`, {
                    //     record: { organizationId: adminOrganizationId }
                    // }));
                }
            },
